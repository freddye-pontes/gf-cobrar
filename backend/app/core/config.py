...
class Settings(BaseSettings):
    ...
    # Asaas
    ASAAS_API_KEY: str = "$aact_prod_000MzkwODA2MWY2OGM3MWRlMDU2NWM3MzJlNzZmNGZhZGY6OjVkOTIwMTM0LTVjZWMtNGVjMi04MDFkLTIxZGZjZGE1ZmMyMzo6JGFhY2hfZGQ3OWFjMzYtZjAyYS00OWM3LWE4NDgtZThkNDBmMmY0MDBm"
