...
from app.routers import credores, devedores, dividas, negociacoes, repasses, dashboard, importar, admin, relatorios, whatsapp, regua, cobrancas, webhooks, auth
...
app.include_router(regua.router, prefix=prefix)
app.include_router(cobrancas.router, prefix=prefix)
